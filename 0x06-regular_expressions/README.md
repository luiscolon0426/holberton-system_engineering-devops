...
```
RB13@ubuntu$ cat example.rb
#!/usr/bin/env ruby
puts ARGV[0].scan(/127.0.0.[0-9]/).join
RB13@ubuntu$
RB13@ubuntu$ ./example.rb 127.0.0.2
127.0.0.2
RB13@ubuntu$ ./example.rb 127.0.0.1
127.0.0.1
RB13@ubuntu$ ./example.rb 127.0.0.a
...
```
RB13@ubuntu$ ./0-simply_match_holberton.rb School | cat -e
School$
RB13@ubuntu$ ./0-simply_match_holberton.rb "Best School" | cat -e
School$
RB13@ubuntu$ ./0-simply_match_holberton.rb "School Best School" | cat -e
SchoolSchool$
RB13@ubuntu$ ./0-simply_match_holberton.rb "Grace Hopper" | cat -e
$
...
```
RB13@ubuntu$ ./5-beginning_and_end.rb 'hn' | cat -e
$
RB13@ubuntu$ ./5-beginning_and_end.rb 'hbn' | cat -e
hbn$
RB13@ubuntu$ ./5-beginning_and_end.rb 'hbtn' | cat -e
$
RB13@ubuntu$ ./5-beginning_and_end.rb 'h8n' | cat -e
h8n$
RB13@ubuntu$
$
...
```
RB13@ubuntu$ ./6-phone_number.rb 4155049898 | cat -e
4155049898$
RB13@ubuntu$ ./6-phone_number.rb " 4155049898" | cat -e
$
RB13@ubuntu$ ./6-phone_number.rb "415 504 9898" | cat -e
$
RB13@ubuntu$ ./6-phone_number.rb "415-504-9898" | cat -e
$
RB13@ubuntu$
...
```
RB13@ubuntu$ ./7-OMG_WHY_ARE_YOU_SHOUTING.rb "I realLy hOpe VancouvEr posseSs Yummy Soft vAnilla Dupper Mint Ice Nutella cream" | cat -e
ILOVESYSADMIN$
RB13@ubuntu$ ./7-OMG_WHY_ARE_YOU_SHOUTING.rb "WHAT do you SAY?" | cat -e
WHATSAY$
RB13@ubuntu$ ./7-OMG_WHY_ARE_YOU_SHOUTING.rb "cannot read you" | cat -e
$
RB13@ubuntu$
...
-   GitHub repository: `alx-system_engineering-devops`
-   Directory: `0x06-regular_expressions`
-   File: `7-OMG_WHY_ARE_YOU_SHOUTING.rb`m
