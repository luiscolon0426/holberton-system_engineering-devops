...
-   You do not needo handle edge cases such as:
    -   Empty parameters
...
```
RB13@ubuntu$ dig www.holberton.online | grep -A1 'ANSWER SECTION:'
;; ANSWER SECTION:
www.holberton.online.   87  IN  A   54.210.47.110
RB13@ubuntu$ dig lb-01.holberton.online | grep -A1 'ANSWER SECTION:'
;; ANSWER SECTION:
lb-01.holberton.online. 101 IN  A   54.210.47.110
RB13@ubuntu$ dig web-01.holberton.online | grep -A1 'ANSWER SECTION:'
;; ANSWER SECTION:
web-01.holberton.online. 212    IN  A   34.198.248.145
RB13@ubuntu$ dig web-02.holberton.online | grep -A1 'ANSWER SECTION:'
;; ANSWER SECTION:
web-02.holberton.online. 298    IN  A   54.89.38.100
RB13@ubuntu$
RB13@ubuntu$
RB13@ubuntu$ ./0-world_wide_web holberton.online
The subdomain www is a A record and points to 54.210.47.110
The subdomain lb-01 is a A record and points to 54.210.47.110
The subdomain web-01 is a A record and points to 34.198.248.145
The subdomain web-02 is a A record and points to 54.89.38.100
RB13@ubuntu$
RB13@ubuntu$ ./0-world_wide_web holberton.online web-02
The subdomain web-02 is a A record and points to 54.89.38.100
RB13@ubuntu$
...
-   GitHub repository: `holberton-system-engineering_devops`
...
```
RB13@ubuntu$ curl -sI https://www.holberton.online
HTTP/1.1 200 OK
...
Accept-Ranges: bytes
RB13@ubuntu$
RB13@ubuntu$ curl https://www.holberton.online
...
```
RB13@ubuntu$ curl -sIL http://www.holberton.online
...
-   GitHub repository: `holberton-system-engineering_devops`
-   Directory: `0x10-https_ssl`
-   File: `100-redirect_http_to_https` t
