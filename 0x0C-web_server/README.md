...
```
RB13@ubuntu cat 88-script_example
#!/usr/bin/env bash
...
At the end of this projet, you are expected to be able to [explain to anyone](https://alx-intranet.hbtn.io/rltoken/EHyxcIwPtD2SzEGRKOnT3g "explain to anyone"), **without the help of Google**:
...
```
RB13@ubuntu$ ./0-transfer_file
Usage: 0-transfer_file PATH_TO_FILE IP USERNAME PATH_TO_SSH_KEY
RB13@ubuntu$
RB13@ubuntu$ ssh ubuntu@8.8.8.8 -i /vagrant/RB13 'ls ~/'
afile
RB13@ubuntu$
RB13@ubuntu$ touch some_page.html
RB13@ubuntu$ ./0-transfer_file some_page.html 8.8.8.8 RB13 /vagrant/private_key
some_page.html                                     100%   12     0.1KB/s   00:00
RB13@ubuntu$ ssh ubuntu@8.8.8.8 -i /vagrant/private_key 'ls ~/'
afile
some_page.html
RB13@ubuntu$
...
-   GitHub repository: `holberton-system_engineering_devops`
-   Directory: `0x0C-web_server`
-   File: `0-transfer_file`c
