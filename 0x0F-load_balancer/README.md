...
```
RB13@ubuntu$ curl -sI 34.198.248.145 | grep X-Served-By
X-Served-By: 03-web-01
RB13@ubuntu$ curl -sI 54.89.38.100 | grep X-Served-By
X-Served-By: 03-web-02
RB13@ubuntu$

```

If your server's hostnames are not properly configured (`[STUDENT_ID]-web-01` and `[STUDENT_ID]-web-02`.), follow this [tutorial](https://alx-intranet.hbtn.iorltoken/tLVI0yDpGJXb-Op5Lo0JtQ "tutorial").
...
```
RB13@ubuntu$ curl -Is 54.210.47.110
HTTP/1.1 200 OK
