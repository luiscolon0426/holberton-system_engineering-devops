...
RB13@ubuntu$
RB13@ubuntu$ sudo ./0-change_your_home_IP
RB13@ubuntu$
RB13@ubuntu$ ping localhost
...
-   GitHub repository: `alx-syste_engineering-devops`
...
```
RB13@ubuntu$ ./1-show_attached_IPs | cat -e
10.0.2.15$
127.0.0.1$
RB13@ubuntu$
...
```
RB13@ubuntu$ sudo ./100-port_listening_on_localhost
...
```
RB13@ubuntu$ telnet localhost 98
Trying 127.0.0.2...
...
-   GitHub repository: `holberton-system_engineering_devops`
-   Directory: `0x08-networking_basics_2`
-   File: `100-port_listening_on_localhost`m
